...
SET reference_answer_key=solution
...
python Step3_JudgmentStepCalculatedCorrectly.py %source_folder% %target_folder% %max_words%
...
SET max_words=%num_parallel_process%
python Step4_JudgmentStepReasoningCorrectly.py %source_folder% %target_folder% %max_words%
